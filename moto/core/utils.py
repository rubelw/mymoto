...
def camelcase_to_underscores(argument):
    ...
    if DEBUG:
        logging.debug('core/utils.py - camelcase_to_underscore -caller: ' + str(inspect.stack()[1][3]) + "-" + get_linenumber())
...
class convert_httpretty_response(object):
    ...
    def __init__(self, callback):
        if DEBUG:
            logging.debug('core/utils.py - covert_httpretty_response __init__ -caller: ' + str(
    ...
    def __name__(self):
        ...
        if DEBUG:
            logging.debug('core/utils.py - covert_httpretty_response __name__ -caller: ' + str(
                inspect.stack()[1][3]) + "-" + get_linenumber())
    ...
    def __call__(self, request, url, headers, **kwargs):
        ...
        if DEBUG:
            logging.debug('core/utils.py - covert_httpretty_response __call__ -caller: ' + str(inspect.stack()[1][3]) + "-" + get_linenumber())
...
class convert_flask_to_httpretty_response(object):
    ...
    def __init__(self, callback):
        ...
        if DEBUG:
            logging.debug('core/utils.py - covert_flask_to_httpretty_response __init__ -caller: ' + str(
                inspect.stack()[1][3]) + "-" + get_linenumber())
    ...
    def __name__(self):
        ...
        if DEBUG:
            logging.debug('core/utils.py - covert_flask_to_httpretty_response __name__ -caller: ' + str(
                inspect.stack()[1][3]) + "-" + get_linenumber())
    ...
    def __call__(self, args=None, **kwargs):
        ...
        if DEBUG:
            logging.debug('core/utils.py - covert_flask_to_httpretty_response __caller__ -caller: ' + str(
                inspect.stack()[1][3]) + "-" + get_linenumber())
...
class convert_flask_to_responses_response(object):
    ...
    def __init__(self, callback):
        ...
        if DEBUG:
            logging.debug('core/utils.py - covert_flask_to_responses_response __init__ -caller: ' + str(
                inspect.stack()[1][3]) + "-" + get_linenumber())
    ...
    def __name__(self):
        ...
        if DEBUG:
            logging.debug('core/utils.py - covert_flask_to_responses_response __name__ -caller: ' + str(
                inspect.stack()[1][3]) + "-" + get_linenumber())
    ...
    def __call__(self, request, *args, **kwargs):
        ...
        if DEBUG:
            logging.debug('core/utils.py - covert_flask_to_responses_response __call__ -caller: ' + str(
                inspect.stack()[1][3]) + "-" + get_linenumber())
            logging.debug("\trequest: "+str(request))
            logging.debug("\targs: "+str(*args))
            logging.debug("\tkwars: "+str(**kwargs))
