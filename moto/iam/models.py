...
class MFADevice(object):
    ...
    def __init__(self,
        ...
        if DEBUG:
            logging.debug('models.py - MFADevice(object) __init__ -caller: '+str(inspect.stack()[1][3])+"-"+get_linenumber())
...
class Role(BaseModel):
    ...
    def __init__(self, role_id, name, assume_role_policy_document, path):
        ...
        if DEBUG:
            logging.debug('models.py - Role(BaseModel) __init__ -caller: '+str(inspect.stack()[1][3])+"-"+get_linenumber())
...
class InstanceProfile(BaseModel):
    ...
    def __init__(self, instance_profile_id, name, path, roles):
        ...
        if DEBUG:
            logging.debug('models.py - InstanceProfile(BaseModel) __init__ -caller: '+str(inspect.stack()[1][3])+"-"+get_linenumber())
...
class Certificate(BaseModel):
    ...
    def __init__(self, cert_name, cert_body, private_key, cert_chain=None, path=None):
        ...
        if DEBUG:
            logging.debug('models.py - Certificate(BaseModel) __init__ -caller: '+str(inspect.stack()[1][3])+"-"+get_linenumber())
...
class AccessKey(BaseModel):
    ...
    def __init__(self, user_name):
        ...
        if DEBUG:
            logging.debug('models.py - AccessKey(BaseModel) __init__ -caller: '+str(inspect.stack()[1][3])+"-"+get_linenumber())
...
class Group(BaseModel):
    ...
    def __init__(self, name, path='/'):
        ...
        if DEBUG:
            logging.debug('models.py - Group(BaseModel) __init__ -caller: '+str(inspect.stack()[1][3])+"-"+get_linenumber())
...
class User(BaseModel):
    ...
    def __init__(self, name, path=None):
        ...
        if DEBUG:
            logging.debug('models.py - User(BaseModel) __init__ -caller: '+str(inspect.stack()[1][3])+"-"+get_linenumber())
...
class IAMBackend(BaseBackend):
    ...
    def __init__(self):
        ...
        if DEBUG:
            logging.debug('models.py - IAMBackend(BaseBackend) __init__ -caller: '+str(inspect.stack()[1][3])+"-"+get_linenumber())
    ...
    def update_role(self, role_name, description):
        role = self.get_role(role_name)
        role.description = description
        return role
