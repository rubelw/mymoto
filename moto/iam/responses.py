...
class IamResponse(BaseResponse):
    ...
    def create_role(self):
        ...
        if DEBUG:
            logging.debug('responses.py -IamResponse(BaseResponse) create_role -caller: '+str(inspect.stack()[1][3])+"-"+get_linenumber())
        ...
        if DEBUG:
            logging.debug("\treturning: "+str(template.render(role=role)))
