...
class LogsResponse(BaseResponse):
    ...
    def tag_log_group(self):
        ...
        log_group = self.logs_backend.tag_log_group(log_group_name, tags)
        sys.stderr.write(str(log_group))
    ...
    def list_tags_log_group(self):
        ...
        log_group = self.logs_backend.get_log_group(log_group_name)
        tags = self.logs_backend.get_log_group_tags(log_group_name)
